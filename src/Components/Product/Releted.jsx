...
export default function Releted() {
  ...
  return (
    <>
    <div className="container text-start  my-5 pt-5">
      <h2 className="fs-5 fw-bold color">Action</h2>
      <h1 className="fw-bold mb-4">Related Games</h1>

      <div className="row g-4 justify-content-center mt-5 pb-5">
        {catcards.map((card) => (
